...
/**
 * This class really just builds the background where the feed from the camera is displayed. There is no OpenCV material
 * here.
 * 
...
public abstract class CameraViewBase extends SurfaceView implements SurfaceHolder.Callback, Runnable
{
    ...
    /**
     * NOTE: These comments where taken from OpenCV This method is called when the preview process is being started. It
     * is called before the first frame delivered and processFrame is called It is called with the width and height
     * parameters of the preview process. It can be used to prepare the data needed during the frame processing.
     * 
     * @param previewWidth
     *            - the width of the preview frames that will be delivered via processFrame
     * @param previewHeight
     *            - the height of the preview frames that will be delivered via processFrame
     */
    protected abstract void onPreviewStarted(int previewWidtd, int previewHeight);

    /**
     * NOTE: These comments where taken from OpenCV This method is called when preview is stopped. When this method is
     * called the preview stopped and all the processing of frames already completed. If the Bitmap object returned via
     * processFrame is cached - it is a good time to recycle it. Any other resources used during the preview can be
     * released.
     */
