...
public class BTService
{
    ...
    // super-dangerous: can we change handlers?
    ...
    protected class AcceptThread extends Thread
    {
        ...
        public AcceptThread()
        {
            ...
            try {
                tmp = BluetoothManager.getBtAdapter().listenUsingRfcommWithServiceRecord(NAME, MY_UUID);
            }
            catch (IOException e) {
            }
            mmServerSocket = tmp;
    ...
    protected class ConnectThread extends Thread
    {
        ...
        public void run()
        {
            ...
            BluetoothManager.getBtAdapter().cancelDiscovery();
