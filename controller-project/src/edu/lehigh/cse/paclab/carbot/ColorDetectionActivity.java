...
public class ColorDetectionActivity extends Activity {
	...
	/**
	 * Took this object declaration block from OpenCv. Basically, this
	 * application is developed using async initialization. That means that it
	 * uses the OpenCV manager (as separate app) to access OpenCV libraries
	 * externally installed in the target system. I am not sure if we want to do
	 * static initialization or not, but OpenCV recommended this route so I just
	 * went with it.
	 */
