...
public class ArduinoService extends Service
{
    ...
    private static final String ACTION_USB_PERMISSION = "edu.lehigh.cse.paclab.carbot.USB_PERMISSION";
            ...
            if (ACTION_USB_PERMISSION.equals(action)) {
                synchronized (this) {
                    ...
                    if (intent.getBooleanExtra(UsbManager.EXTRA_PERMISSION_GRANTED, false)) {
                        ...
                        Log.d("CARBOT", "permission denied for accessory " + accessory);
                    }
    ...
    class IncomingHandler extends Handler
    {
        ...
        public void handleMessage(Message msg)
        {
            ...
            if (CMD.equals("STOP"))
                cmdStop();
            /*
             * Log.e("MESSAGE", "Got message"); Bundle data = msg.getData();
             * String urlPath = data.getString(ArduinoService.URLPATH); String
             * fileName = data.getString(ArduinoService.FILENAME); String
             * outputPath = download(urlPath, fileName);
             * 
             * Message backMsg = Message.obtain(); backMsg.arg1 = result; Bundle
             * bundle = new Bundle(); bundle.putString(RESULTPATH, outputPath);
             * backMsg.setData(bundle); try { outMessenger.send(backMsg); }
     ...
     * 
     * [mfs] It seems that we need this to run after we get a reply from the
     * intent...
     */
    ...
    {
        closeAccessory();
        // [TODO] big trouble if this is not registered...
